...
differently.) Antonym of Bohr bug; see also mandelbug, schroedinbug. In C, nine
out of ten heisenbugs result from uninitialized auto variables, fandango on core
...
we need are tools to make it happen concurrently\ldots
\end{block}
...
\begin{frame}{The Actor Model of Computation}
\begin{block}{Actors are purely concurrent}
\begin{itemize}
