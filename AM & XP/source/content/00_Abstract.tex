...
developers. Agile Modeling (AM) is a methodology for modeling and documentation,
which can be used as an extension for almost any software process.

This paper shows how an already efficient software process, such as
